...
//change text
if (hourNow >= 5 && hourNow < 12) welcome.innerHTML = "GOOD MORNING";
if (hourNow >= 12 && hourNow < 18) welcome.innerHTML = "GOOD AFTERNOON";
if (hourNow >= 18 || hourNow < 5) welcome.innerHTML = "GOOD EVENING";
